...
const SelectParent = ({ selectId, setSelectId }: Props) => {
    ...
    return <>
        ...
        <div className="relative max-h-[180px] overflow-auto shadow-3xl sm:rounded-lg mb-5">
            {
                keyword &&
                            ...
                            return (
                                <tr
                                    ...
                                    <td className="px-6 py-4">
                                        <input type="radio" name="selectParent" id={x.id} title={x.id} value={x.id}
                                            checked={selectId === x.id} onChange={e => setSelectId(e.target.value)}
                                        />
                                    </td>
                                    <th
                                        scope="row"
