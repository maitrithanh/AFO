...
import ChartHealth from "@/app/components/parent/chart/ChartHealth";
...
const HealthPage = () => {
  ...
  return (
    <div className="w-full m-auto h-[88vh] overflow-auto rounded-lg bg-white p-4 md:p-10">
      ...
      <div className="">
        {healthData?.map((health: any) => {
          return (
            <div
              key={health?.examDate}
              className="relative p-4 bg-white w-full shadow-3xl my-4 rounded-lg"
            >
              ...
              <div className="w-full text-xl">
                <div className="flex justify-between text-black border-b border-dashed py-1">
                ...
                <div className="flex justify-between text-black border-b  py-1">
